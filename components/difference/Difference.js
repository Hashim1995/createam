            ...
            <Zoom>
              <div className={Style.DifferenceItem}>
                ...
                <p className={Style.DifferenceItemText}>
                  ...
                  Bootstrap framework to build the website. It’s the best in
                  class.
                </p>
              </div>
            </Zoom>
            ...
            <Zoom>
              <div className={Style.DifferenceItem}>
                ...
                <p className={Style.DifferenceItemText}>
                  ...
                  need to run your business. Change image and text and you’re
                  good to go!
                </p>
              </div>
            </Zoom>
            ...
            <Zoom>
              <div className={Style.DifferenceItem}>
                <DashboardCustomizeOutlinedIcon
                  className={Style.DifferenceItemIcon}
                />
                <h3 className={Style.DifferenceItemTitle}>
                  Fully Customizable
                </h3>
                <p className={Style.DifferenceItemText}>
            ...
            <Zoom>
              <div className={Style.DifferenceItem}>
                ...
                <p className={Style.DifferenceItemText}>
                  ...
                  template. You can use any of them that goes with your
                  branding.
                </p>
              </div>
            </Zoom>
            ...
            <Zoom>
              <div className={Style.DifferenceItem}>
                ...
                <p className={Style.DifferenceItemText}>
                  ...
                  keep updating our products to stay up to date with latest
          ...
          <Col xs={24} sm={12} md={12} lg={8}>
            <Zoom>
              <div className={Style.DifferenceItem}>
                ...
                <p className={Style.DifferenceItemText}>
                  All the pages of this template are optimized. We used
                  Bootstrap framework to build the website. It’s the best in
                  class.
                </p>
              </div>
